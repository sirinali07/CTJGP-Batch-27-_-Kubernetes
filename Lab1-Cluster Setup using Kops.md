...
* `Syntax:` aws autoscaling update-auto-scaling-group --auto-scaling-group-name "Your-AG-Name" --desired-capacity 0 --region "Your-region"
```
aws autoscaling update-auto-scaling-group --auto-scaling-group-name nodes-us-east-2a.sirin-2024-03-19-16-03.k8s.local --desired-capacity 3 --region us-east-2
```
